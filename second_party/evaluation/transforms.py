...
def get_val_transform(model, num_crops, crop_size, clip_length, num_clips):
    if num_crops == 1 and num_clips == 1:
        ...
        val_transform = transforms.Compose(
            [
                ...
                SpatialCrop(crop_size=crop_size, num_crops=num_crops),
            ]
        )
