...
from second_party.evaluation.charades.base_dataset import TextVideoDataset
...
if __name__ == "__main__":
    ...
    #     data_dir="/ptmp/dduka/databases/charades_ego/CharadesEgo_v1_480",
    #     meta_dir="/ptmp/dduka/databases/charades_ego/CharadesEgo",
    ...
    # for i, item in enumerate(charades_val_loader):
    #     video = item["video"]
    ...
    cls_arr = []
    with open(os.path.join('/ptmp/dduka/databases/charades_ego/CharadesEgo', 'Charades_v1_classes.txt'), 'r') as charades:
    ...
    tokenized = tokenizer(cls_arr)
    print(f"Length of original classes: {len(cls_arr)}")
    print(f"Length of tokenized classes: {tokenized.shape[0]}")
    print(f"Shape of tokenized classes: {tokenized.shape}")
    print(f"Tokenized classes: {tokenized}")
    print(f"Tokenized classes: {tokenizer(cls_arr)}")