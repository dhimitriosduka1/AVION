...
echo "Evaluation of QWEN refined standard Ego4D dataset with 10 captions"
python3 /u/dduka/project/AVION/second_party/utils/evaluate_refinement.py --csv /u/dduka/project/AVION/second_party/utils/manual.csv --pkl /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/standard/pickle/ego4d_train_standard_10_caption_vllm_with_uuid.pkl
