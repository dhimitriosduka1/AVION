...
python3 /u/dduka/project/AVION/second_party/utils/evaluate_refinement.py \
    ...
    /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/scaled/pickle/ego4d_train_ttrv_standard_scaled_400_step_with_uuid.pkl \
    /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/scaled/pickle/ego4d_train_ttrv_scaled_scaled_400_step_with_uuid.pkl \
    --names "Original Ego4D" "2.1x Scaled Ego4D" "vLLM Original Ego4D 1 Caption" "vLLM Scaled Ego4D 1 Caption" "vLLM Original Ego4D 10 Captions" "TTRV Standard Standard 400 Step" "Deduplicated Ego4D" "TTRV Standard Scaled 400 Step" "TTRV Scaled Scaled 400 Step"\
    --include_scaled \
