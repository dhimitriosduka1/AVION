...
python3 /u/dduka/project/AVION/second_party/utils/evaluate_refinement.py \
    ...
    --names "Original Ego4D" "2.1x Scaled Ego4D" "vLLM Original Ego4D 1 Caption" "vLLM Scaled Ego4D 1 Caption" "vLLM Original Ego4D 10 Captions" \
    # --include_scaled \
    # --min_scale 1.0 \
    # --max_scale 2.0 \
    # --original_pkl /dais/fs/scratch/dduka/databases/ego4d/ego4d_train_with_uuid.pkl \
    # --video_info /dais/fs/scratch/dduka/databases/ego4d/video_lengths.json \