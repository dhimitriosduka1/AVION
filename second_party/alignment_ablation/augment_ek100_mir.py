...
def apply_safe_dynamic_augmentations(input_csv, output_dir):
    ...
    experiments = {
        ...
        "scale_0_95x_train": ("scale", 0.95),
        "scale_0_9x_train": ("scale", 0.9),
        "scale_0_85x_train": ("scale", 0.85),
        "scale_0_8x_train": ("scale", 0.8),
        "scale_0_75x_train": ("scale", 0.75),
        "scale_0_7x_train": ("scale", 0.7),
        "scale_0_7x_train": ("scale", 0.65),
        "scale_0_6x_train": ("scale", 0.6),
        "scale_0_55x_train": ("scale", 0.55),
        "scale_0_5x_train": ("scale", 0.5),
    }
...
if __name__ == "__main__":
    ...
    ran_experiments, iou_results = apply_safe_dynamic_augmentations(INPUT_CSV, OUTPUT_DIR)
