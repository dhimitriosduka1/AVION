...
#SBATCH --job-name scaled_padding
...
uv run ./second_party/qwen3vl/vllm_refine.py \
    ...
    --output_file /ptmp/dduka/databases/ego4d/qwen_refinement/scaled/output_1_caption_1_padding_362k_subset.jsonl \
    --pkl_path /ptmp/dduka/databases/ego4d/ego4d_train_362k_subset_2.1x_with_uuid.pkl \
