...
#SBATCH -o /ptmp/dduka/work/logs/avion/std_ttrv_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/std_ttrv_%A_%a_%x_%j_%N.err

#SBATCH --job-name std_ttrv
...
uv run ./second_party/qwen3vl/vllm_refine.py \
    ...
    --output_file /ptmp/dduka/databases/ego4d/qwen_refinement/standard/output_1_caption_ttrv_form_standard_checkpoint_400.jsonl \
    --pkl_path /ptmp/dduka/databases/ego4d/ego4d_train_with_uuid.pkl \
    --model_path /ptmp/dduka/work/training_metadata/ttrv/actor_merged/ \
