...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_baseline_vitl_ek100_mir_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_baseline_vitl_ek100_mir_%A_%a_%x_%j_%N.err
...
RUN_NAME=EK100_MIR_LAVILA_PRETRAIN_BASELINE_VITL14
