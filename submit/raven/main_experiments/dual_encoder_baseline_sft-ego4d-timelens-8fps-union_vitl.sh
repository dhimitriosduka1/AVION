...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_sft-ego4d-timelens-8fps-union_vitl14_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_sft-ego4d-timelens-8fps-union_vitl14_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_pretrain_sft-ego4d-timelens-8fps-union_vitl14
...
RUN_NAME=DUAL_ENCODER_SFT-EGO4D-TIMELENS-8FPS-UNION_VITL14
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/refined_dataset/sft-ego4d-timelens-8fps-union/refined_data_without_uuid.pkl \