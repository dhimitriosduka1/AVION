...
#SBATCH -o /ptmp/dduka/work/logs/avion/dual_encoder_qwen_refined_ek100_mir_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/dual_encoder_qwen_refined_ek100_mir_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_qwen_refined_ek100_mir
...
RUN_NAME=EK100_MIR_DUAL_ENCODER_QWEN_REFINED
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --pretrain-model /ptmp/dduka/work/training_metadata/avion/DUAL_ENCODER_QWEN_REFINED/checkpoint_best.pt \
    --output-dir $EXP_PATH \
    --wandb \
