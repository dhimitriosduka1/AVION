...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_baseline_zsh_qwen_vitl_ek100_mir_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_baseline_zsh_qwen_vitl_ek100_mir_%A_%a_%x_%j_%N.err

#SBATCH --job-name lavila_pretrain_baseline_zsh_qwen_vitl_ek100_mir
...
RUN_NAME=EK100_MIR_LAVILA_PRETRAIN_ZSH_QWEN_REFINED_VITL14
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --pretrain-model /ptmp/dduka/work/training_metadata/avion/LAVILA_PRETRAIN_ZSH_QWEN_REFINED_VITL14/checkpoint_best.pt \
    --output-dir $EXP_PATH \
    --wandb \
