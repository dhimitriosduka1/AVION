...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_qwen_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_qwen_%A_%a_%x_%j_%N.err

#SBATCH --job-name lavila_pretrain_qwen_vitl
...
RUN_NAME=LAVILA_PRETRAIN_ZSH_QWEN_REFINED_VITL14
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --model CLIP_VITL14 \
    --train-metadata /ptmp/dduka/databases/ego4d/refined_dataset/baseline_qwen3vl/refined_lavila_data.pkl \
