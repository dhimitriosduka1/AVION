...
#SBATCH -o /ptmp/dduka/work/logs/avion/dual_encoder_midpoint_extension_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/dual_encoder_midpoint_extension_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_midpoint_extension_vitl
...
RUN_NAME=DUAL_ENCODER_MIDPOINT_EXTENSION_VITL
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/midpoint_no_uuid.pkl \