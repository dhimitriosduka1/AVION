...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_qwen_de_vitl14_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_qwen_de_vitl14_%A_%a_%x_%j_%N.err
