...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_baseline_de_vitl14_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_baseline_de_vitl14_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_pretrain_baseline_vitl14
...
RUN_NAME=DUAL_ENCODER_EGO4D_VITL14_
