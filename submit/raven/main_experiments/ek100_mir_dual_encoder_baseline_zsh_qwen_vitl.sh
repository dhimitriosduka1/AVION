...
RUN_NAME=EK100_MIR_DUAL_ENCODER_QWEN_REFINED_VITL14_
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --pretrain-model /ptmp/dduka/work/training_metadata/avion/DUAL_ENCODER_QWEN_REFERENCE_VITL14_/checkpoint_best.pt \
    --output-dir $EXP_PATH \
    --wandb \
