...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_sft-ego4d-timelens-8fps-union_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_sft-ego4d-timelens-8fps-union_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_pretrain_sft-ego4d-timelens-8fps-union
...
RUN_NAME=DUAL_ENCODER_SFT-EGO4D-TIMELENS-8FPS-UNION
