...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_qwen_de_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_qwen_de_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_pretrain_qwen
...
RUN_NAME=DUAL_ENCODER_QWEN_REFINED
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/refined_dataset/baseline_qwen3vl/refined_data.pkl \