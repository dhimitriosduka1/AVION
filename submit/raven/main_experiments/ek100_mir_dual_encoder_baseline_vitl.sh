...
#SBATCH -o /ptmp/dduka/work/logs/avion/dual_encoder_baseline_ek100_mir_vitl_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/dual_encoder_baseline_ek100_mir_vitl_%A_%a_%x_%j_%N.err
