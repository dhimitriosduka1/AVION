...
#SBATCH -o /ptmp/dduka/work/logs/avion/lavila_pretrain_laviti_de_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/lavila_pretrain_laviti_de_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_pretrain_laviti_vitl
...
RUN_NAME=DUAL_ENCODER_LAVITI_VITL
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/laviti_no_uuid.pkl \