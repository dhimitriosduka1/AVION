...
#SBATCH -o /ptmp/dduka/work/logs/avion/minilm_embedder_dist_original_ds_vs_temperature_1.0_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/minilm_embedder_dist_original_ds_vs_temperature_1.0_%A_%a_%x_%j_%N.err

#SBATCH --job-name minilm_embedder_dist_original_ds_vs_temperature_1.0
