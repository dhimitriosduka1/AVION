...
python3 -m second_party.postprocess.resolve_embeddings_sim_dist \
    --source-run-name "lavila_temperature_0.7_preprocess_caption_v2" \
    --embeddings-path /ptmp/dduka/databases/ego4d/embeddings/lavila_narrator/0.7/preprocess_caption_v2/lavila/ \
    --method "subset" \
    --n-pairs 1000000 \
    --bins 200 \
