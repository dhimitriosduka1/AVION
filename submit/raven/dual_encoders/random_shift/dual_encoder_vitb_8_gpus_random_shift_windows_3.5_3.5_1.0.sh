...
RUN_NAME=DUAL_ENCODER_PRETRAIN_BASELINE_256_RANDOM_SHIFT_WIND-3.5-3.5-1.0
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/random_shift_timestamps/ego4d_train_random_shift_3.5_3.5_1.0_42.pkl \
    --use-flash-attn \
    --grad-checkpointing \
    --use-fast-conv1 \
    --batch-size 256 \
