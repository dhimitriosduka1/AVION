...
RUN_NAME=DUAL_ENCODER_PRETRAIN_BASELINE_256_RANDOM_SHIFT_WIND-1.5-2.5-1.0_SEED_256
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/random_shift_timestamps/ego4d_train_random_shift_1.5_2.5_1.0_256.pkl \
    --use-flash-attn \
    --grad-checkpointing \
    --use-fast-conv1 \
    --batch-size 256 \
