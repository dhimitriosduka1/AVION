...
RUN_NAME=DUAL_ENCODER_PRETRAIN_BASELINE_256_SIM_BASED_THRESHOLD_0.95_EMBEDDINGS_10
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/similarity_based_shift_timestamps/PE-Core-bigG-14-448_meta/ego4d_train_temperature_0.7_threshold_0.95_embeddings_10.pkl \
    --use-flash-attn \
    --grad-checkpointing \
    --use-fast-conv1 \
    --batch-size 256 \
