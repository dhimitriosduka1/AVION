...
#SBATCH -o /ptmp/dduka/work/logs/avion/dual_encoder_pretrain_scheduler_corse_to_fine_%A_%a_%x_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/dual_encoder_pretrain_scheduler_corse_to_fine_%A_%a_%x_%j_%N.err

#SBATCH --job-name dual_encoder_pretrain_scheduler_corse_to_fine
...
RUN_NAME=DUAL_ENCODER_PRETRAIN_SCHEDULER_CORSE_TO_FINE
