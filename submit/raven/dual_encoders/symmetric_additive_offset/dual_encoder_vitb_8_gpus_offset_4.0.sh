...
RUN_NAME=DUAL_ENCODER_PRETRAIN_BASELINE_256_SYMMETRIC_ADDITIVE_OFFSET_4.0
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /ptmp/dduka/databases/ego4d/symmetric_additive_offset/ego4d_train_symmetric_additive_offset_4.0.pkl \
    --use-flash-attn \
    --grad-checkpointing \
    --use-fast-conv1 \
    --batch-size 256 \
