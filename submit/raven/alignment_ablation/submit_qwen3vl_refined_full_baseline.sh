...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_refined_full_baseline_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_refined_full_baseline_%j_%N.err

#SBATCH --job-name=qwen3vl_refined_full_baseline
...
export TRAIN_METADATA="/ptmp/dduka/databases/ego4d/refined_dataset/baseline_qwen3vl/refined_data.pkl"
...
RUN_NAME="qwen3vl_refined_full_baseline"
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --resume /ptmp/dduka/work/training_metadata/avion/${RUN_NAME}/checkpoint.pt \
