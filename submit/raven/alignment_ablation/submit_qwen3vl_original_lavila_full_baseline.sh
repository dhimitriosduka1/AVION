...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_original_full_lavila_baseline_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_original_full_lavila_baseline_%j_%N.err

#SBATCH --job-name=qwen3vl_original_full_lavila_baseline
...
export TRAIN_METADATA="/ptmp/dduka/databases/ego4d/ego4d_train.rephraser.no_punkt_top3.pkl"
...
RUN_NAME="qwen3vl_full_original_lavila_baseline"
