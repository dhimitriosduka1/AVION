...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_refined_2.7M_subset_baseline_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_refined_2.7M_subset_baseline_%j_%N.err

#SBATCH --job-name=qwen3vl_refined_2.7M_subset_baseline
...
RUN_NAME="qwen3vl_refined_2.7M_subset_baseline"
