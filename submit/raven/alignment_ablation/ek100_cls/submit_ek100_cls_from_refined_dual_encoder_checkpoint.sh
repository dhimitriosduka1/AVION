...
#SBATCH -o /ptmp/dduka/work/logs/avion/ek100_cls_finetune_from_refined_dual_encoder.out
#SBATCH -e /ptmp/dduka/work/logs/avion/ek100_cls_finetune_from_refined_dual_encoder.err

#SBATCH --job-name ek100_cls_finetune_from_refined_dual_encoder
...
RUN_NAME=ek100_cls_from_qwen3vl_refined_dual_encoder
