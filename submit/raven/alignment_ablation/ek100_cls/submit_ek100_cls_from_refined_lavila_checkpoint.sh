...
#SBATCH -o /ptmp/dduka/work/logs/avion/ek100_cls_finetune_from_refined_lavila.out
#SBATCH -e /ptmp/dduka/work/logs/avion/ek100_cls_finetune_from_refined_lavila.err

#SBATCH --job-name ek100_cls_finetune_from_refined_lavila
...
RUN_NAME=ek100_cls_from_qwen3vl_refined_lavila
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --pretrain-model /ptmp/dduka/work/training_metadata/avion/qwen3vl_full_refined_lavila_baseline/checkpoint_best.pt \
    --wandb \
