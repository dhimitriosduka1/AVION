...
#SBATCH -o /ptmp/dduka/work/logs/avion/ek100_cls_finetune_from_original_lavila.out
#SBATCH -e /ptmp/dduka/work/logs/avion/ek100_cls_finetune_from_original_lavila.err

#SBATCH --job-name ek100_cls_finetune_from_original_lavila
...
RUN_NAME=ek100_cls_from_qwen3vl_original_lavila
