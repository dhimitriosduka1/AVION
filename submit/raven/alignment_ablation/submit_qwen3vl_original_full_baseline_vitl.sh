...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_original_full_baseline_vitl_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_original_full_baseline_vitl_%j_%N.err

#SBATCH --job-name=qwen3vl_original_full_baseline_vitl
...
RUN_NAME="qwen3vl_original_full_baseline_vitl"
