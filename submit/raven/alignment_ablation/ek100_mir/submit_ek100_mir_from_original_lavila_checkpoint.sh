...
#SBATCH -o /ptmp/dduka/work/logs/avion/ek100_mir_finetune_from_original_lavila.out
#SBATCH -e /ptmp/dduka/work/logs/avion/ek100_mir_finetune_from_original_lavila.err

#SBATCH --job-name ek100_mir_finetune_from_original_lavila
...
RUN_NAME=ek100_mir_from_qwen3vl_original_lavila
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --pretrain-model /ptmp/dduka/work/training_metadata/avion/qwen3vl_full_original_lavila_baseline/checkpoint_best.pt \
    --wandb \
