...
#SBATCH -o /ptmp/dduka/work/logs/avion/ek100_mir_finetune_from_refined_lavila.out
#SBATCH -e /ptmp/dduka/work/logs/avion/ek100_mir_finetune_from_refined_lavila.err

#SBATCH --job-name ek100_mir_finetune_from_refined_lavila
...
RUN_NAME=ek100_mir_from_qwen3vl_refined_lavila
