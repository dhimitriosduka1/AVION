...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_original_full_baseline_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_original_full_baseline_%j_%N.err

#SBATCH --job-name=qwen3vl_original_full_baseline
...
RUN_NAME="qwen3vl_original_full_baseline"
