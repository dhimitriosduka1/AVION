...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_refined_full_baseline_vitl_336px_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_refined_full_baseline_vitl_336px_%j_%N.err

#SBATCH --job-name=qwen3vl_refined_full_baseline_vitl_336px
...
RUN_NAME="qwen3vl_refined_full_baseline_vitl_336px"
