...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_refined_full_lavila_baseline_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_refined_full_lavila_baseline_%j_%N.err

#SBATCH --job-name=qwen3vl_refined_full_lavila_baseline
...
export TRAIN_METADATA="/ptmp/dduka/databases/ego4d/refined_dataset/baseline_qwen3vl/refined_lavila_data.pkl"
export TRAIN_METADATA_AUX="/ptmp/dduka/databases/ego4d/ego4d_train.narrator_63690737.return_10.pkl"
...
RUN_NAME="qwen3vl_full_refined_lavila_baseline"
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata-aux $TRAIN_METADATA_AUX \
    --use-flash-attn \
    --grad-checkpointing \
    --use-fast-conv1 \
    --batch-size 512 \
    ...
    --wandb-project-name "Alignment Run"