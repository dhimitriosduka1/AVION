...
#SBATCH -o /ptmp/dduka/work/logs/avion/qwen3vl_original_full_baseline_vitl_336px_%j_%N.out
#SBATCH -e /ptmp/dduka/work/logs/avion/qwen3vl_original_full_baseline_vitl_336px_%j_%N.err

#SBATCH --job-name=qwen3vl_original_full_baseline_vitl_336px
...
export TRAIN_METADATA="/ptmp/dduka/databases/ego4d/refined_dataset/baseline_qwen3vl/original_data.pkl"
...
RUN_NAME="qwen3vl_original_full_baseline_vitl_336px"
