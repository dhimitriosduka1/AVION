...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/lavila_1_caption_standard_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/lavila_1_caption_standard_%A_%a_%x_%j_%N.err

#SBATCH -J lavila_1_caption_standard
...
RUN_NAME=DAIS_LAVILA_REFINED_QWEN_1_CAPTION_STANDARD
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/standard/pickle/ego4d_train.rephraser.no_punkt_top3_refined_qwen_1_caption_vllm.pkl \
