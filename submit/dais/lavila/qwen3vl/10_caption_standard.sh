...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/lavila_10_caption_standard_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/lavila_10_caption_standard_%A_%a_%x_%j_%N.err

#SBATCH -J lavila_10_caption_standard
...
RUN_NAME=DAIS_LAVILA_QWEN_REFINED_10_CAPTION_STANDARD
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/standard/pickle/ego4d_train.rephraser.no_punkt_top3_refined_qwen_10_caption_vllm.pkl \
