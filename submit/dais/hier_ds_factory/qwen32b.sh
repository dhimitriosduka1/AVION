...
#SBATCH -o ./qwen32b_ddp_%A_%a.out
#SBATCH -e ./qwen32b_ddp_%A_%a.err
#SBATCH -J qwen32b_ddp
...
torchrun --nproc_per_node=4 \
    ...
    --output-path /dais/fs/scratch/dduka/databases/ego4d/ego4d_train_qwen_pairwise_32b.pkl \
    --model Qwen/Qwen2.5-32B-Instruct \
    --batch-size 64 \
    --wandb-project "Ego4D-Merging" \
    --wandb-run-name "Qwen-32B-4xH200-DDP"