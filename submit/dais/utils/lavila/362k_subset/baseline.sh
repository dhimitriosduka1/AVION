...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/lavila_baseline_362K_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/lavila_baseline_362K_%A_%a_%x_%j_%N.err

#SBATCH -J l_baseline_362k
...
RUN_NAME=DAIS_LAVILA_BASELINE_362K
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --workers 16 \
    --prefetch-factor 2 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/subset/ego4d_train.rephraser.no_punkt_top3_refined_362k_subset.pkl \
