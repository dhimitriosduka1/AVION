...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/lavila_1c_scaled_362K_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/lavila_1c_scaled_362K_%A_%a_%x_%j_%N.err

#SBATCH -J l_1c_scaled_362k
...
RUN_NAME=DAIS_LAVILA_1_CAP_SCALED_362K
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --workers 16 \
    --prefetch-factor 2 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/subset/ego4d_train.rephraser.no_punkt_top3_refined_scaled_362k_1_caption_vllm.pkl \
