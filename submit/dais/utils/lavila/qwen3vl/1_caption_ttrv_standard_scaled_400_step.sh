...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/lavila_ttrv_s_scaled_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/lavila_ttrv_s_scaled_%A_%a_%x_%j_%N.err

#SBATCH -J lavila_ttrv_s_scaled
...
RUN_NAME=DAIS_LAVILA_TTRV_STANDARD_SCALED_400_STEP
