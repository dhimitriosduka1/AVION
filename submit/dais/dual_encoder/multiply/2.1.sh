...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/dual_encoder_mult_2.1%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/dual_encoder_mult_2.1%A_%a_%x_%j_%N.err

#SBATCH -J dual_encoder_mult_2.1
...
RUN_NAME=D_DUAL_ENCODER_MULT_2.1
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --grad-checkpointing \
    --use-fast-conv1 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/random_shift/ego4d_train_random_shift_2.1_2.1_1.0_42.pkl \
    --batch-size 512 \
    --freeze-temperature \
    --fused-decode-crop \
    --fix-lr \
