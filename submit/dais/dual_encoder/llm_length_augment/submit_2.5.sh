...
RUN_NAME=DAIS_DUAL_ENCODER_LLM_LEN_AUG_2.5
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --workers 32 \
    --prefetch-factor 4 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/verb_aware/ego4d_train_verb_aware_2.5_original_clamped.pkl \
