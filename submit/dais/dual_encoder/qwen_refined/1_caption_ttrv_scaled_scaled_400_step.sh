...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/de_scl_scl%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/de_scl_scl%N.err
...
RUN_NAME=DAIS_DUAL_ENC_1_CAPTION_TTRV_SCALED_SCALED_400_STEP
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --workers 16 \
    --prefetch-factor 2 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/scaled/pickle/ego4d_train_ttrv_scaled_scaled_400_step.pkl \