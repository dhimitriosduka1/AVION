...
RUN_NAME=DAIS_DUAL_ENC_1_CAPTION_SCALED_QWEN3VL_1k_VLLM
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --workers 32 \
    --prefetch-factor 4 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/qwen_refinement/scaled/pickle/ego4d_train_scaled_1_caption_1k_subset_vllm.pkl \