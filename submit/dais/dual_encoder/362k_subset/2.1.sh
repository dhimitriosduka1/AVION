...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/dual_encoder_2.1_362K_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/dual_encoder_2.1_362K_%A_%a_%x_%j_%N.err

#SBATCH -J de_2.1x_362k
...
RUN_NAME=DAIS_DUAL_ENC_2.1x_362K
...
srun --cpu_bind=v --accel-bind=gn torchrun \
    ...
    --workers 16 \
    --prefetch-factor 2 \
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/subset/ego4d_train_362k_subset_2.1x.pkl