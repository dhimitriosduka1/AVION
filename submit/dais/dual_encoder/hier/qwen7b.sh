...
#SBATCH -o /dais/fs/scratch/dduka/logs/avion/dual_encoder_qwen_7b_%A_%a_%x_%j_%N.out
#SBATCH -e /dais/fs/scratch/dduka/logs/avion/dual_encoder_qwen_7b_%A_%a_%x_%j_%N.err
#SBATCH -J qwen_7b
...
RUN_NAME="DAIS_DUAL_ENC_HIER_QWEN_2.5_7B"
...
torchrun \
    ...
    --train-metadata /dais/fs/scratch/dduka/databases/ego4d/ego4d_train_Qwen2.5-7B-Instruct.pkl \
    --workers 32 \
    --prefetch-factor 4 \